...
//                                zTree.checkNode(treeNode, true, true);
        ...
        .controller('navBarController', ['$scope', '$rootScope','user.loader','Util','Tools','Loading','toaster','$timeout',function($scope, $rootScope,loader,Util,Tools,Loading,toaster,$timeout) {
            ...
            var userParentBefore = '                        <li class="header-menu"></li>\n' +
                ...
                '                                <ul>';
            //<img src="/assets/img/m1.png" style="width: 25px;margin-right: 10px;"/> <img src="/assets/img/m2.png" style="width: 25px;margin-right: 10px;"/>
            //<img src="/assets/img/m3.png" style="width: 25px;margin-right: 10px;"/>
            //<img src="/assets/img/m4.png" style="width: 25px;margin-right: 10px;"/>
            //<img src="/assets/img/u18.png" style="width: 25px;margin-right: 10px;"/>
            ...
            var uploadBefore = '                        <li class="sidebar-dropdown">\n' +
                ...
                '                            <div class="sidebar-submenu" >\n' +
                '                                <ul>';
            //<img src="/assets/img/m6.png" style="width: 25px;margin-right: 10px;"/>
            ...
            var deployParent = '                        <li class="sidebar-dropdown">\n' +
                ...
                '                            <div class="sidebar-submenu" >\n' +
                '                                <ul>';
            //<img src="/assets/img/m7.png" style="width: 25px;margin-right: 10px;"/>
            //<img src="/assets/img/m8.png" style="width: 25px;margin-right: 10px;"/>
            ...
            var processParent = ' <li class="sidebar-dropdown">\n' +
                ...
                '                            <div class="sidebar-submenu">\n' +
                '                                <ul>';
            //<img src="/assets/img/m9.png" style="width: 25px;margin-right: 10px;"/>
            //<img src="/assets/img/m10.png" style="width: 25px;margin-right: 10px;"/>
            //<img src="/assets/img/m11.png" style="width: 25px;margin-right: 10px;"/>
            ...
            var pendingParent = '  <li class="sidebar-dropdown">\n' +
                '                            <a id="shenpi"><i class="fa fa-tasks"></i><span>合同归档管理模块</span></a>\n' +
                '                            <div class="sidebar-submenu" >\n' +
                '                                <ul>';
            //
            ...
            var logParent = '                <li class="sidebar-dropdown">\n' +
                ...
                '                            <div class="sidebar-submenu" >\n' +
                '                                <ul>';
            //<img src="/assets/img/m16.png" style="width: 25px;margin-right: 10px;"/>
